...
function AddNomineeForm({ programId, batchId, fetchBatchPeopleList, setShowAddNominee }) {
    const { userData } = useAuth();
    const emailSuffixArray = ["@wagonslearning.com", "@axisbank.com", "@idfcfirstbank.com"];
    const [emailSuffix, setEmailSuffix] = useState({ value: "@wagonslearning.com", label: "@wagonslearning.com" });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                `${process.env.REACT_APP_PUBLIC_URL}/api/batches/addUserToBatch?access_token=${userData?.accessToken}`,
                {
                    headers: {
                ...
                <div className="w-full md:col-span-2  px-2">
                    ...
                    <div className="flex flex-wrap items-stretch w-full relative">
                        ...
                        <div className="flex -mr-px">
                            <Select
                                options={emailSuffixArray.map(suffix => ({ value: suffix, label: suffix }))}
