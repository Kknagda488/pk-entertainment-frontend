...
function Venue({ batchId, getOneBatch, batchData }) {
  ...
  async function handleVenueUpdate(e) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_PUBLIC_URL}/api/Teams/venueUpdate/${batchData.teamId}?access_token=${userData?.accessToken}`,
      {
        headers: {
  ...
  const fetchVenues = async () => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/api/batchVenues/list?&access_token=${userData?.accessToken}`
      );
      const data = await response.json();
  ...
  const updateVenue = async (e) => {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_PUBLIC_URL}/api/batches/updateVenue/${batchId}?access_token=${userData?.accessToken}`,
      {
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
        },
  ...
  const handleAddAndUpdateVenue = async (e) => {
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/api/batches/addAndUpdateVenue/${batchId}?access_token=${userData?.accessToken}`,
        {
          headers: {
            "Content-Type": "application/x-www-form-urlencoded",
          },
