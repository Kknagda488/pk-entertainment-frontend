...
function LineChart() {
  ...
  var listName =
    userData.userType == 1 || userData.userType == 6 || userData.userType == 7 || userData.userType == 8
  ...
  const getChartDetails = () => {
    fetch(
      `${process.env.REACT_APP_PUBLIC_URL}/api/Users/${listName}?access_token=${userData?.accessToken}`
    )
      .then(async (response) => {
