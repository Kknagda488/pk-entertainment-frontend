...
const TrainerWiseReport = () => {
  ...
  const reportDownloader = async () => {
    ...
    response = await fetch(
      `${process.env.REACT_APP_PUBLIC_URL}/api/reports/trainerWiseReport?access_token=${userData?.accessToken}`,
      {
        headers: {
  ...
  const handleAllExport = (allExportAttendenceData) => {
    ...
    Utils.exportAoaToXlsx(employees, `TrainerWise-Report-${Date.now()}`);
  };
...
export default TrainerWiseReport