...
function AttendenceForm() {
    ...
    if (!employee) {
      ...
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_PUBLIC_URL}/api/batchAttendences/addAttendence`,
          {
            headers: {
  ...
  const fetchIdfcEmployeeDetails = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/api/nominees/getByEmail?filter=${params}`
      );
      const data = await response.json();
      if (data.status === "failure") {
  ...
  const handleAttenceIDFCForm = async (e) => {
    ...
    if (!employee) {
      ...
      try {
        ...
        // return console.log(form);
        const response = await fetch(
          `${process.env.REACT_APP_PUBLIC_URL}/api/batchAttendences/addAttendenceforIdfc  `,
          {
            headers: {
              "Content-Type": "application/x-www-form-urlencoded",
            },
  ...
  const addAttendenceFormReq = async (e) => {
    ...
    try {
      ...
      // return console.log(form);
      const response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/api/batchAttendences/addAttendenceforAxis`,
        {
          headers: {
            "Content-Type": "application/x-www-form-urlencoded",
          },
