...
const schema = Yup.object().shape({
  ...
  managerEmail: Yup.string()
    .matches(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, "Please Enter Valid Manager Email")
  ...
  const handleNomineeFormSubmit1 = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/api/nominees/register`,
        {
          headers: {
                  ...
                  <form onSubmit={handleSubmit(handleNomineeFormSubmit)}>
                    ...
                    <div className="py-4 px-2 space-x-4">
                      <button
                        type="submit"
                        disabled={loading}
                        className={`${tenantKey === "10d08176f2e74175ba526ab1b23beecc"
                          ? "bg-[#003366]"
