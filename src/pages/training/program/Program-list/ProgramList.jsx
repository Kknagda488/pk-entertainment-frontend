...
function ProgramList() {
  ...
  const fetchPrograms = async () => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/api/programs/listByCompany/${tenantKey}`
      );
  ...
  const fetchPrgramOutineURl = async (programid) => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/api/programOutlines/getFile/${programid}?access_token=${userData?.accessToken}`
      );
      const result = await response.json();
      if (response.ok) {
  ...
  return (
    <div className="flex  relative flex-col w-full min-h-screen  bg-white">
      ...
      <div className="shadow-lg mx-3">
        ...
        <div className={`hidden md:flex ${tenantKey === "10d08176f2e74175ba526ab1b23beecc" ? 'bg-[#003366]' : tenantKey === "ac7153df458aefc2a93fd1a4f7513147" ? 'bg-[#97144C]' : tenantKey === "uq15v1axohhui5ytm2mxhdzcuywuakj7" ? 'bg-[#9d1d27]' : ''} text-white py-2 px-5`}>
              ...
              >
                      ...
                      <div className="mb-3">
                        <div className="flex flex-col rounded  cursor-pointer">
                          <div className="mb-2 ml-1">
                            ...
                            <BsFileEarmarkPdf size={30} color={tenantKey === "10d08176f2e74175ba526ab1b23beecc" ? 'bg-[#003366]' : tenantKey === "ac7153df458aefc2a93fd1a4f7513147" ? '#97144C' : tenantKey === "uq15v1axohhui5ytm2mxhdzcuywuakj7" ? '#9d1d27' : ''} />
                          </div>
                          {/* <div>
                ...
                <div className="flex-1 p-2">
                  ...
                  <a
                    ...
                    className={`${tenantKey === "10d08176f2e74175ba526ab1b23beecc" ? 'bg-[#003366]' : tenantKey === "ac7153df458aefc2a93fd1a4f7513147" ? 'bg-[#97144C]' : tenantKey === "uq15v1axohhui5ytm2mxhdzcuywuakj7" ? 'bg-[#9d1d27]' : 'bg-[#9d1d27]'
                      } hover:${tenantKey === "10d08176f2e74175ba526ab1b23beecc" ? 'bg-[#003366]' : tenantKey === "ac7153df458aefc2a93fd1a4f7513147" ? 'bg-[#97144C]' : tenantKey === "uq15v1axohhui5ytm2mxhdzcuywuakj7" ? 'bg-[#9d1d27]' : 'bg-[#9d1d27]'
